#DILATE Loss function by Vincent Le Guen et al.
#Link: https://papers.nips.cc/paper_files/paper/2019/hash/466accbac9a66b805ba50e42ad715740-Abstract.html
...
class DilateLoss(LightningModule):
    '''
    Lightning Class
    '''
    ...
    def forward(self, outputs, targets):
        loss, shape, temp = self.dilate_loss(outputs, targets, self.alpha, self.gamma)
        return loss

    def dilate_loss(self, outputs, targets, alpha, gamma):
        ...
        Omega =  pairwise_distances(torch.arange(1,N_output+1).view(N_output,1)).to(self.device)
